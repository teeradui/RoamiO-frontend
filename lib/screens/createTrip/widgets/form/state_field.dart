...
class StateField extends StatelessWidget {
  const StateField({super.key, required this.viewModel, this.onChanged});
      ...
      onTap: !enabled
          ...
          : () async {
              final result = await showModalBottomSheet<Map<String, dynamic>>(
                ...
                builder: (context) {
                  return _StateSearchSheet(states: viewModel.states);
                },
              );
...
class _StateSearchSheet extends StatefulWidget {
  const _StateSearchSheet({required this.states});
