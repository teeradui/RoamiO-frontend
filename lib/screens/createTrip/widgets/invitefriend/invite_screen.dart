...
import 'package:roamio_frontend/screens/createTrip/widgets/invitefriend/friend_card.dart';
...
class _Step2InviteFriendsState extends State<Step2InviteFriends> {
  ...
  Future<void> _handleCreateTrip() async {
    ...
    final success = await createTripViewModel.submitCreateTrip();
    ...
    await _showCreateTripError(
      createTripViewModel.errorMessage ?? 'Unable to create trip.',
    );

    createTripViewModel.clearError();
  }
  ...
  Future<void> _showCreateTripError(String message) async {
    if (!mounted) return;
