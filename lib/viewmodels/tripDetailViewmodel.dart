...
import 'package:roamio_frontend/models/services/locationTrackingService.dart';
...
class TripDetailViewModel extends ChangeNotifier {
  ...
  TripDetailViewModel({
    ...
    LocationTrackingService? locationTrackingService,
        ...
        _locationTrackingService = locationTrackingService ?? LocationTrackingService();
  ...
  Future<void> loadTrip() async {
    ...
    try {
      final results = await Future.wait([
        ...
        _tripMemberService.getMembersByTrip(tripId),
      ]);
  ...
  Future<void> endTrip() async {
    try {
      await _tripService.updateTripStatus(tripId, trip_model.TripStatus.completed);
      status = TripStatus.completed;
      await _locationTrackingService.stop();
      notifyListeners();
    } catch (e) {
      errorMessage = "Unable to end trip.";
      notifyListeners();
    }
  }
